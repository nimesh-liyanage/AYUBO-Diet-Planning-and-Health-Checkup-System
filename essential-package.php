...
<h3 id="packName" class="packageName">Essential Health Check Package</h3>

<div class="image-container">
<img src="http://localhost/iwt/src/images/packagePhoto.jpeg" class="image">
<div class="text-container">
<h2 class="Price">Rs.10,450.00</h2>
...
<a class="pacLink" href = "payment.php?price=10450&packageId=2"><button class="btn1">Proceed to Checkout</button></a>
</div>
</div>
