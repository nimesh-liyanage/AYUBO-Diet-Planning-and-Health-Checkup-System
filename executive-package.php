...
<h3 id="packName" class="packageName">Executive Health Check Package</h3>

<div class="image-container">
<img src="http://localhost/iwt/src/images/packagePhoto.jpeg" class="image">
<div class="text-container">
<h2 class="Price">Rs.15,000.00</h2>
...
<a class="pacLink" href = "payment.php?price=15000&packageId=4"><button class="btn1">Proceed to Checkout</button></a>
</div>
</div>
